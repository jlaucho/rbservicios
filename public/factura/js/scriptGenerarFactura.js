...
jQuery(document).ready(function() {
    $(".precioU").blur(function() {
        //var count = 0;
        var precioUnidad = new Array;
            //$('.precioU').each(function(){
               precioUnidad[0] = $(".precioU").serializeArray();
               alert(precioUnidad[0]);
          var myJsonString = JSON.stringify(precioUnidad);
            //});
            alert(myJsonString.precioUnidad[1]);


        //var presUnidad = $('input[name="precioUnidad[]"]').val();
        //alert(presUnidad);
