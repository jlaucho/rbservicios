...
/*
    Se capturan los datos enviados del formulario HTML
    para cargarlos en la tabla que se va a convertir en PDF
*/

require_once("dompdf/dompdf_config.inc.php"); 

function doPDF($path='',$content='',$body=true,$style='',$mode=true,$paper_1='a4',$paper_2='portrait') 
{     
